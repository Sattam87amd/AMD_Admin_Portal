...
const PendingExpertsRequestProfile = () => {
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="mx-auto max-w-4xl bg-white rounded-lg shadow-sm border border-gray-200 p-8">
        {/* Header */}
        ...
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Ayaan Raje</h2>
        <p className="text-gray-600 mb-8">Wellness Expert India</p>
